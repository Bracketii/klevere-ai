								...
								<div class="stepper-nav ps-lg-10">
									...
									<div class="stepper-item current" data-kt-stepper-element="nav">
										...
										<div class="stepper-wrapper">
											...
											<div class="stepper-label">
												<h3 class="stepper-title">Choose</h3>
												<div class="stepper-desc">First choose your avatar</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Wrapper-->
									...
									<div class="stepper-item" data-kt-stepper-element="nav">
										...
										<div class="stepper-wrapper">
											...
											<!--begin::Label-->
											<div class="stepper-label">
												<h3 class="stepper-title">Options</h3>
												<div class="stepper-desc">Select your options</div>
											</div>
											<!--begin::Label-->
										</div>
										<!--end::Wrapper-->
									...
									<div class="stepper-item" data-kt-stepper-element="nav">
										...
										<div class="stepper-wrapper">
											...
											<div class="stepper-label">
												...
												<div class="stepper-desc">Generate your results!</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Wrapper-->
									...
									<div class="stepper-item mark-completed" data-kt-stepper-element="nav">
										...
										<div class="stepper-wrapper">
											...
											<!--begin::Label-->
											<div class="stepper-label">
												<h3 class="stepper-title">Pick Your Avatar Now!</h3>
												<div class="stepper-desc">Pick your avatar and get results!</div>
											</div>
											<!--end::Label-->
										</div>
										<!--end::Wrapper-->
								...
								<form class="form" novalidate="novalidate" id="kt_modal_create_app_form">
										...
										<div class="w-100">
											...
											<div class="fv-row">
												...
												<label class="d-flex align-items-center fs-5 fw-semibold mb-4">
													<span class="">Select Avatar</span>
													<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Select your avatar from menu"></i>
												</label>
												<!--end::Label-->
												<!--begin:Options-->
												<div class="fv-row">
														...
														<span class="d-flex align-items-center me-2">
															...
															<span class="symbol symbol-50px me-6">
																<span class="symbol-label bg-light-primary">
																	<i class="fa-solid fa-robot" style="color: #009EF7; font-size:22px"></i>
																</span>
															</span>
															<!--end:Icon-->
															<!--begin:Info-->
															<span class="d-flex flex-column">
																<span class="fw-bold fs-6">Select Avatar</span>
																<span class="fs-7 text-muted">Select your avatar from sidebar menu. We have Marketing, Sales, HR expert and more!</span>
															</span>
															<!--end:Info-->
														</span>
														<!--end:Label-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											<!--begin::Heading-->
											<h1 class="fw-bold text-dark mb-3">Choose your avatar and try now!</h1>
											<!--end::Heading-->
											<!--begin::Description-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="card">
															<a href="#">
																<div class="card-body">
																	<img src="assets/media/avatars/300-23.jpg" class="symbol symbol-50px me-3" style="width: 65px; margin-bottom:15px" alt="">
																	<h3>Bryan</h3>
																	<p style="font-size: 14px">Marketing expert</p>
																</div>
															</a>
														</div>
													</div>
													<div class="col-md-6">
														<div class="card">
															<a href="#">
																<div class="card-body">
																	<img src="assets/media/avatars/300-13.jpg" class="symbol symbol-50px me-3" style="width: 65px; margin-bottom:10px" alt="">
																	<h3>Sam</h3>
																	<p style="font-size: 14px">Tech expert</p>
																</div>
															</a>
														</div>
													</div>
