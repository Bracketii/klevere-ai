				...
				<div class="pb-20 pt-20">
					...
					<div class="container">
										...
										<div class="d-flex h-100 align-items-center">
											...
											<div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
												...
												<div class="mb-7 text-center">
													<!--begin::Title-->
													<h1 class="text-dark mb-5 fw-boldest">{{ $products->name}}</h1>
													<!--end::Title-->
													<!--begin::Description-->
													<div class="text-gray-400 fw-semibold mb-5">Description</div>
													<!--end::Description-->
													<!--begin::Price-->
													<div class="text-center">
														<span class="mb-2 text-primary">$</span>
														<span class="fs-3x fw-bold" style="color: #2468FF" data-kt-plan-price-month="99" data-kt-plan-price-annual="999">{{$products->price}}</span>
                        ...
                        <form action="{{route('checkout',$products->id)}}" method="post">
                          @csrf
												<input type="submit" value="Select" class="btn btn-primary" style="background-color: #2468FF">
                        </form>
												<!--end::Select-->
											</div>
											<!--end::Option-->
