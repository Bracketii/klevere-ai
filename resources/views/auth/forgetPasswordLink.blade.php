	...
	<body id="kt_body" class="app-blank app-blank">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				<!--begin::Logo-->
				<a href="../../demo27/dist/index.html" class="d-block d-lg-none mx-auto py-20">
				...
				<div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
					...
					<div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
						...
						<div class="d-flex flex-stack py-2">
							<!--begin::Back link-->
							<div class="me-2">
								<a href="../../demo27/dist/authentication/layouts/fancy/sign-in.html" class="btn btn-icon bg-light rounded-circle">
							...
							<div class="m-0">
								...
								<a href="../../demo27/dist/authentication/layouts/fancy/sign-in.html" class="link-primary fw-bold fs-5" data-kt-translate="new-password-head-link">Sign In</a>
							</div>
							<!--end::Sign Up link=-->
						</div>
						<!--end::Header-->
						...
						<div class="py-20">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="../../demo27/dist/authentication/layouts/fancy/sign-in.html" method="POST" action="{{ route('reset.password.post') }}">
								@csrf
								<!--begin::Heading-->
