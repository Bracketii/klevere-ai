            ...
            <div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
                ...
                <div class="page-title gap-4 me-3 mb-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 mb-2">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-gray-600 fw-bold lh-1">KlevereChat</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                    <!--begin::Title-->
                    <h1 class="text-gray-900 fw-bolder m-0">KlevereChat</h1>
                    <h4 class="text-gray-400 fw-bolder m-0">Ask me anything</h4>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                <!--begin::Action-->
                                                    ...
                                                    <div class="d-flex flex-column align-items-start">
                                                        ...
                                                        <div class="d-flex align-items-center mb-2">
                                                            ...
                                                            <div class="symbol symbol-35px symbol-circle">
                                                                <img alt="Pic" src="assets/media/avatars/klevereLogoIconBlack.svg" />
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <!--begin::Details-->
                                                            <div class="ms-3">
                                                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">Klevere</a>
