		...
		<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
			...
			<div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
				...
				<div class="page-title gap-4 pt-5 pb-1 me-3 mb-5 mb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_wrapper'}">
					...
					<!--end::Breadcrumb-->
					<!--begin::Title-->
					<h1 class="text-gray-900 fw-bolder m-0">Aaron</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
				<!--begin::Action-->
                                ...
                                <div class="card" id="kt_chat_messenger" style="height: 600px">
                                    ...
                                    <div class="card-header" id="kt_chat_messenger_header">
                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="d-flex justify-content-center flex-column me-3">
                                                <a href="#" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">Aaron</a>
                                                <!--begin::Info-->
                                                <div class="mb-0 lh-1">
                                            ...
                                            <div class="d-flex justify-content-start mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        ...
                                                        <!--begin::Details-->
                                                        <div class="ms-3">
                                                            <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">Aaron</a>
                                                            <span class="text-muted fs-7 mb-1">HR</span>
                                                        </div>
                                                        <!--end::Details-->
                                                    </div>
                                                    <!--end::User-->
                                                    ...
                                                    <script>
                                                        ...
                                                        strings: ["Hi there! My name is Aaron. I'm here for your HR solutions"],
                                                        typeSpeed: 30,
                                                        showCursor: false
                                                    });
                                                    </script>
                                            ...
                                            <div class="d-flex justify-content-start mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    {{-- <div class="p-5 rounded bg-light-primary text-dark fw-semibold mw-lg-400px text-start" style="background-color: #EBF1FF !important" data-kt-element="message-text">How likely are you to recommend our company to your friends and family ?</div> --}}
                                                        ...
                                                        <form action="{{ route('projectSave.hr')}}" method="POST">
                                                            {{ csrf_field() }}
                                    ...
                                    <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                                        ...
                                        <form action="{{ route('hr.result')}}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                                            {{ csrf_field() }}
                                        <textarea name="text" type="text" class="form-control form-control-flush mb-3" rows="1" data-kt-element="input" placeholder="How can I recruit employees for my new business?" style="font-size:16px; color:black;" autofocus id="chat-input"></textarea>
                                        <!--end::Input-->
                                        <!--begin:Toolbar-->
