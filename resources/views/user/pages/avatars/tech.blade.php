                                ...
                                <div class="card" id="kt_chat_messenger" style="height: 600px">
                                            ...
                                            <div class="d-flex justify-content-start mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    <script>
                                                        ...
                                                        strings: ["Hi there! My name is Sam. I'm a Tech expert. Ask me anyhting for your technological solutions..."],
                                                        typeSpeed: 30,
                                                        showCursor: false
                                                    });
                                                    </script>
                                            ...
                                            <div class="d-flex justify-content-start mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    {{-- <div class="p-5 rounded bg-light-primary text-dark fw-semibold mw-lg-400px text-start" style="background-color: #EBF1FF !important" data-kt-element="message-text">How likely are you to recommend our company to your friends and family ?</div> --}}
                                                        ...
                                                        <form action="{{ route('projectSave.tech')}}" method="POST">
                                                            {{ csrf_field() }}
                                    ...
                                    <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                                        ...
                                        <form action="{{ route('tech.result')}}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                                            {{ csrf_field() }}
                                        <textarea name="text" type="text" class="form-control form-control-flush mb-3" rows="1" data-kt-element="input" placeholder="How to develop a desktop application?" style="font-size:16px; color:black;" autofocus id="chat-input"></textarea>
                                        <!--end::Input-->
                                        <!--begin:Toolbar-->
