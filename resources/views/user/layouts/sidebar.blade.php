            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                <div class="menu-item pt-5">
                    ...
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">User Panel</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    ...
                    <a href="{{ route('user.dashboard') }}" class="menu-link">
                        ...
                        <!--end::Icon-->
                        <!--begin::Title-->
                        <span class="menu-title dashboard-menu-title">Home</span>
                        <!--end::Title-->
                        <!--begin::Badge-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('sales.chat') }}" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('hr.chat') }}" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('artist.chat') }}" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="{{ route('tech.chat') }}" title="" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div class="menu-item">
                    ...
                    <a href="{{ route('chat') }}" class="menu-link">
                        <!--begin::Icon-->
                        <span class="menu-icon">
                            <i class="fonticon-chat dashboard-icons"></i>
                        </span>
                        <!--end::Icon-->
                        <!--begin::Title-->
                        ...
                        <!--begin::Badge-->
                        <span class="menu-badge">
                            <span class="badge badge-light-warning badge-sm dashboard-menu-badge">Ask me anything</span>
                        </span>
                        <!--end::Badge-->
                    </a>
                    <!--end:::Menu link-->
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Resources</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <!--end:Menu item-->
                ...
                <div class="menu-item">
                    <!--begin::Menu link-->
                    <a id="kt_help_toggle" class="menu-link">
                        <!--begin::Icon-->
                        <span class="menu-icon">
                            <i class="fonticon-setting dashboard-icons"></i>
                        </span>
                        <!--end::Icon-->
                        <!--begin::Title-->
                        <span class="menu-title dashboard-menu-title">Help & Support</span>
                        <!--end::Title-->
                    </a>
                    <!--end:::Menu link-->
                </div>
        ...
        <div class="">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color  fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                ...
                <div class="menu-item px-5">
                    <a href="{{ route('user.account') }}" class="menu-link px-5">My Account</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-5 my-1">
                    <a href="{{ route('user.billing') }}" class="menu-link px-5">Plans & Billing</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-5 my-1">
                    <a id="kt_help_toggle" data-bs-dismiss="click" data-bs-trigger="hover" class="menu-link px-5">Help Center</a>
                </div>
                <!--end::Menu item-->
